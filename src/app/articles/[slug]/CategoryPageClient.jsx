    ...
    const fetchCategory = async () => {
      try {
        ...
        const [categoryRes, blogsRes] = await Promise.all([
          apiClient.get(`/blogs/categories/${slug}`),
          apiClient.get(`/blogs/categories/${slug}/blogs?page=${currentPage}&limit=${BLOGS_PER_PAGE}`)
        ]);
        ...
        if (categoryRes.data?.category) {
          ...
          try {
            const productsRes = await apiClient.get(`/products/index?category=${encodeURIComponent(categoryRes.data.category.name)}&status=active&limit=1`);
      ...
      <div className="px-4 md:px-6 lg:px-8 py-4 md:py-6 lg:py-8 max-w-7xl mx-auto" style={{ paddingTop: '140px' }}>
        ...
        <div className="mb-8 md:mb-12">
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            ...
            {category.ipshopySlug && (
              <Link
                href={`https://ipshopy.com/${category.ipshopySlug}`}
                target="_blank"
